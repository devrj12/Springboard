...
FROM SLACK CHANNEL
***********
the first one is a pop up login
user:  student
pass:  springboardbackup
the second one is the regular phpmyadmin login
user:  admin_springboard
pass:  springboardbackup
the database name is admin_springboard
************
